...
-- Слайдер
Section:NewSlider("Верх вниз перса", "SliderInfo", 100, 0, function(h) -- 500 (Макс. значение) | 0 (Мин. значение)
   game.Players.LocalPlayer.Character.Humanoid.HipHeight = h
end)

Section:NewButton("Ноуклип", "ButtonInfo", function()
...
Section:NewSlider("Гравитация", "SliderInfo", 1000, 0, function(g) -- 500 (Макс. значение) | 0 (Мин. значение)
